# BeamScale / cached-rpc

This is the BeamScale lane for the matched `cached-rpc` workload. The hosted
...
just compose-plan stacks/beamscale/projects/cached-rpc
just compose-up stacks/beamscale/projects/cached-rpc
```
